...
public final class StudentAnalytics {
     ...
     * https://www.coursera.org/learn/parallel-programming-in-java/discussions/weeks/2/threads/dI8C838rEeej8w6jIFJDiA
     * https://www.coursera.org/learn/parallel-programming-in-java/discussions/weeks/2/threads/kSZXxaXMEeeSgBIYX3zlwA
     * 
     * @param studentArray Student data for the class.
     * @return Most common first name of inactive students
     */
...
/*    	return Stream.of(studentArray)
    	...
    	.parallel()
    	.filter(s -> !s.checkIsCurrent())
    	.collect(Collectors.toMap(s -> s.getFirstName(), s -> 1, (s , a) -> s+a))
    	.entrySet()
    	.parallelStream()
    	.max(Map.Entry.comparingByValue())
    	.get()
